...
{/* <NavLink to="/" className="flex flex-col items-center gap-1">
      <div className="group relative">
        <p className="group-hover:text-black">Women Ethnic</p>
        <div className="group-hover:block hidden absolute right-0 top-full w-50 py-3 px-5 bg-slate-100 text-gray-500 rounded">
          <ul className="flex flex-row gap-2">
            ...
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/other-ethnic">Other Ethnic</NavLink>
              <p onClick={() => { }} className='cursor-pointer hover:text-black'>Lenga</p>
<p onClick={() => { }} className='cursor-pointer hover:text-black'>Gown</p>
            </li>
          </ul>
          /////////// <ul className="flex flex-col gap-2 mt-2">
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/cotton-sarees">Cotton Sarees</NavLink>
            </li>
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/satin-sarees">Satin Sarees</NavLink>
            </li>
          </ul>
          <ul className="flex flex-col gap-2 mt-2">
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/rayon-kurtis">Rayon Kurtis</NavLink>
            </li>
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/cotton-kurtis">Cotton Kurtis</NavLink>
            </li>
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/embroidered-kurtis">Embroidered Kurtis</NavLink>
            </li>
          </ul>
          <ul className="flex flex-col gap-2 mt-2">
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/lenga">Lenga</NavLink>
            </li>
            <li className="cursor-pointer hover:text-black">
              <NavLink to="/gown">Gown</NavLink>
            </li>
          </ul> ///////////////////////
        </div>
      </div>
    ...
    {/* <NavLink to="/" className="flex flex-col items-center gap-1">
      <div className="group relative">
        <p className="group-hover:text-black">Women Ethnic</p>
        <div className="group-hover:block hidden absolute right-0 top-full w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
      ...
      <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden" />
                ...
                <NavLink to='/womenwestern' className='flex flex-col items-center gap-1'>
                    {/* <p>Women Western</p> */}
                    <div className='group relative'>
